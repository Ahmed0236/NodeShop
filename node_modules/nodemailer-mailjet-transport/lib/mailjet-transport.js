...
const packageData = require('nodemailer-mailjet-transport/package.json');
const utils = require('nodemailer-mailjet-transport/lib/utils');
const Message = require('nodemailer-mailjet-transport/lib/message');
